package org.flexlite.domUI.skins.spark
{
	 ...
	 * @author DXMLCompiler
	 */
	public class NumericStepperSkin extends SparkSkin
	{
		//==========================================================================
		//                                定义成员变量
		//==========================================================================
		...
		public function NumericStepperSkin()
		{
			...
			this.minHeight = 23;
			this.minWidth = 40;
			this.elementsContent = [incrementButton_i(),decrementButton_i(),textDisplay_i()];
		...
		private function decrementButton_i():Button
		{
			...
			temp.skinName = NumericStepperDecrementButtonSkin;
			return temp;
		}
		...
		private function incrementButton_i():Button
		{
			...
			temp.percentHeight = 50;
			temp.tabEnabled = false;
			temp.skinName = NumericStepperIncrementButtonSkin;
			return temp;
		}

		private function textDisplay_i():TextInput
		{
